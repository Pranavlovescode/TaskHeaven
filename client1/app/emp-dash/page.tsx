...
const Employee = () => {
    ...
    const logoutUser = async () => {
        ...
        const response = await axios.put(`http://localhost:8080/api/auth/logout/${token.loginTimeDetails.time_id}/${token.token}`,
            {email},
            {
                headers:{
                                ...
                                <div className="flex justify-start items-center">
                                    ...
                                    <p className="flex mr-4">
                                        <img src="https://flowbite.s3.amazonaws.com/logo.svg" className="mr-3 h-8"
                                             alt="FlowBite Logo"/>
                                        <span
                                            className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Company X</span>
                                    </p>
                                </div>
                    ...
                    <div className="z-50 absolute right-0">
                        {togglePersonalInfo && (
                            <div
                                ...
                                <span
                                    className="block text-sm font-semibold text-gray-900 dark:text-white">{token.employeeDetails.name}</span>
                                    <span
                                        className="block text-sm text-gray-500 truncate dark:text-gray-400">{token.employeeDetails.email}</span>
                                </div>
