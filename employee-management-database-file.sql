...
(
	...
	mng_email varchar(20) not null unique,
	...
	mng_login_time timestamp not null,
...
(
	...
	adm_email varchar(20) not null unique,
	...
	adm_login_time timestamp not null,
	adm_logout_time timestamp not null
)
