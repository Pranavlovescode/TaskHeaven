          ...
          <CardContent>
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  onChange={(e) =>
                    setFormData({ ...formData, hr_address: e.target.value })
                  }
                  id="address"
                  name="address"
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2">
                  ...
                  <Input
                    onChange={(e) =>
                      setFormData({ ...formData, hr_password: e.target.value })
                    }
                    id="password"
                    name="password"
                    type="password"
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        hr_doj: new Date(e.target.value),
                      })
                    }
                    id="date_of_joining"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Select
                    onValueChange={(value) => {
                      setFormData({ ...formData, hr_designation: value });
                    }}
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Junior Tester">
                        Junior Tester
                      </SelectItem>
                      <SelectItem value="Senior Developer">
                        Senior Developer
                      </SelectItem>
                      <SelectItem value="Senior Tester">
                        Senior Tester
                      </SelectItem>
              ...
              <div>
                ...
                <Select
                  onValueChange={(value) => {
                    setFormData({ ...formData, hr_role: value });
                  }}
                >
                  <SelectTrigger className="w-full">
