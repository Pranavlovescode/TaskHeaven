                    ...
                    <nav className="bg-gray-100 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                        <div className="flex flex-wrap justify-between items-center">
                            ...
                            <div className="flex items-center lg:order-2">
                                ...
                                <span
                                    className="block text-sm font-semibold text-gray-900 dark:text-white">{token.managerDetails.name}</span>
                                        <span
                                            className="block text-sm text-gray-500 truncate dark:text-gray-400">{token.managerDetails.mngemail}</span>
                                    </div>
