                                ...
                                <div className="flex justify-start items-center">
                                    ...
                                    <p className="flex mr-4">
                                        <img src="https://flowbite.s3.amazonaws.com/logo.svg" className="mr-3 h-8"
                                             alt="FlowBite Logo"/>
                                        <span
                                            className="self-center text-2xl font-bold whitespace-nowrap dark:text-white">Company X</span>
                                    </p>
                                </div>
                                ...
                                <div className="grid grid-cols-3 gap-4 p-4">
                                    ...
                                    <a href="/get-emp"
                                       className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                                        ...
                                        <div
                                            className="text-sm font-medium text-gray-900 dark:text-white">Employees
                                        </div>
                                    </a>
                                    <a href="#"
                                       className="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
