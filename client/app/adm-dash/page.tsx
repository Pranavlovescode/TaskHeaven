                        ...
                        <div className="flex flex-wrap justify-between items-center">
                            <div className="flex justify-start items-center">
                                ...
                                <button aria-expanded="true" aria-controls="sidebar"
                                    ...
                                    <svg className="w-[18px] h-[18px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div className="flex items-center lg:order-2">
                                        ...
                                        <li>
                                            <a href="#"
                                               className="flex items-center py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                <svg className="mr-2 w-4 h-4 text-gray-400" aria-hidden="true"
                              ...
                              <span className="flex items-center">
                                  <svg className="mr-2 w-4 h-4 text-blue-600 dark:text-blue-500" aria-hidden="true"
